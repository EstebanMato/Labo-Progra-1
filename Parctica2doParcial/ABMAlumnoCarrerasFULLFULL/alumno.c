...
int hardcodearAlumnos( eAlumno vec[], int tam, int cantidad)
{
    ...
    eAlumno suplentes[]=
    {
        ...
        { 20003, "Luis", 20, 'm', 9, 8, 8.5, {21, 5, 2018},1001, 0},
        { 20004, "Alicia", 21, 'f', 6, 7, 6.5, {11, 9, 2017},1000, 0},
        { 20005, "Diego", 23, 'm', 2, 2, 2, {12, 4, 2014},1000, 0},
        { 20006, "Sofia", 19, 'f', 8, 9, 8.5, {12, 2, 2014},1002, 0},
        { 20007, "Clara", 21, 'f', 2, 4, 3, {28, 8, 2018},1001, 0},
        { 20008, "Mauro", 20, 'm', 4, 7, 10, {23, 3, 2015},1001, 0},
        { 20009, "Daniela", 22, 'f', 2, 8, 10, {10, 10, 2016},1001, 0},
        { 20010, "Agustin", 24, 'm', 6, 7, 10, {1, 7, 2017},1002, 0},
    };
