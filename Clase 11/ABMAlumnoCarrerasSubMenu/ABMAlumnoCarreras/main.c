...
void mostrarAlumnosCarreraSelecionada(eAlumno alumnos[], int tamA, eCarrera carreras[], int tamC, int idCarrera);
void mostrarAlumnosCarrera(eAlumno alumnos[], int tamA, eCarrera carreras[], int tamC);
void mostrarAlumnosDeCarreras(eAlumno alumnos[], int tamA, eCarrera carreras[], int tamC);
...
void mostrarInformes(eAlumno alumnos[], int tamA, eCarrera carreras[], int tamC){
    ...
    do
    {
        ...
        {
        case 1:
            mostrarAlumnosCarrera(alumnos, tamA, carreras, tamC);
            break;

        case 2:
            mostrarAlumnosDeCarreras(alumnos, tamA, carreras, tamC);
            break;
...
void mostrarAlumnosCarrera(eAlumno alumnos[], int tamA, eCarrera carreras[], int tamC)
{
    int idCarrera;
    system("cls");
    printf("****Listado de Alumnos por carreras****\n\n");
    mostrarCarreras(carreras, tamC);

    printf("\nIngrese id de carrera a mostrar: ");
    scanf("%d", &idCarrera);

    mostrarAlumnosCarreraSelecionada(alumnos, tamA, carreras, tamC, idCarrera);
...
void mostrarAlumnosDeCarreras(eAlumno alumnos[], int tamA, eCarrera carreras[], int tamC){
    ...
    for(int i=0; i<tamC; i++){
        ...
        printf("Carrera: %s\n\n", desc);
        mostrarAlumnosCarreraSelecionada(alumnos, tamA, carreras, tamC, carreras[i].id);
    }
